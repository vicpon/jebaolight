...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C05771 implements OnCompleteListener {
        C05771() {
        }
    ...
    class C05782 implements OnCompleteListener {
        C05782() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C05782());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C05771()).build();
            }
