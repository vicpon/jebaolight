...
public class BundleJSONConverter {
    ...
    static class C05701 implements Setter {
        C05701() {
        }
    ...
    static class C05712 implements Setter {
        C05712() {
        }
    ...
    static class C05723 implements Setter {
        C05723() {
        }
    ...
    static class C05734 implements Setter {
        C05734() {
        }
    ...
    static class C05745 implements Setter {
        C05745() {
        }
    ...
    static class C05756 implements Setter {
        C05756() {
        }
    ...
    static class C05767 implements Setter {
        C05767() {
        }
    ...
    static {
        SETTERS.put(Boolean.class, new C05701());
        SETTERS.put(Integer.class, new C05712());
        SETTERS.put(Long.class, new C05723());
        SETTERS.put(Double.class, new C05734());
        SETTERS.put(String.class, new C05745());
        SETTERS.put(String[].class, new C05756());
        SETTERS.put(JSONArray.class, new C05767());
    }
        ...
        for (String key : bundle.keySet()) {
            ...
            if (value != null) {
                if (value instanceof List) {
                    JSONArray jsonArray = new JSONArray();
                    for (String stringValue : (List<String>)value) {
                        jsonArray.put(stringValue);
                    }
                    json.put(key, jsonArray);
