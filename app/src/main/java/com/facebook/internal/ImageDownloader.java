...
public class ImageDownloader {
    ...
    private static void readFromCache(RequestKey key, Context context, boolean allowCachedRedirects) throws Throwable {
    ...
    private static void download(com.facebook.internal.ImageDownloader.RequestKey r19, android.content.Context r20) {
        ...
        r2 = 0;
        r10 = 1;
        r15 = new java.net.URL;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r0 = r19;
        r0 = r0.uri;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r0;
        r16 = r16.toString();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r15.<init>(r16);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r15.openConnection();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r0 = r16;
        r0 = (java.net.HttpURLConnection) r0;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r5 = r0;
        r16 = 0;
        r0 = r16;
        r5.setInstanceFollowRedirects(r0);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r5.getResponseCode();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        switch(r16) {
    ...
    L_0x002b:
        r14 = r5.getErrorStream();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r9 = new java.lang.StringBuilder;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r9.<init>();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        if (r14 == 0) goto L_0x00cf;
    L_0x0036:
        r11 = new java.io.InputStreamReader;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r11.<init>(r14);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = 128; // 0x80 float:1.794E-43 double:6.32E-322;
        r0 = r16;
        r3 = new char[r0];	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
    L_0x0041:
        r16 = 0;
        r0 = r3.length;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r17 = r0;
        r0 = r16;
        r1 = r17;
        r4 = r11.read(r3, r0, r1);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
    ...
    L_0x006c:
        ...
        r16 = "location";
        r0 = r16;
        r12 = r5.getHeaderField(r0);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = com.facebook.internal.Utility.isNullOrEmpty(r12);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        if (r16 != 0) goto L_0x00ae;
    L_0x007b:
        r13 = android.net.Uri.parse(r12);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r0 = r19;
        r0 = r0.uri;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r0;
        r0 = r16;
        com.facebook.internal.UrlRedirectCache.cacheUriRedirect(r0, r13);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r6 = removePendingRequest(r19);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        if (r6 == 0) goto L_0x00ae;
    L_0x0090:
        r0 = r6.isCancelled;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r0;
        if (r16 != 0) goto L_0x00ae;
    L_0x0096:
        r0 = r6.request;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r0;
        r17 = new com.facebook.internal.ImageDownloader$RequestKey;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r0 = r19;
        r0 = r0.tag;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r18 = r0;
        r0 = r17;
        r1 = r18;
    ...
    L_0x00b5:
        r0 = r20;
        r14 = com.facebook.internal.ImageResponseCache.interceptAndCacheImageStream(r0, r5);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r2 = android.graphics.BitmapFactory.decodeStream(r14);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        goto L_0x00ae;
    L_0x00c0:
        com.facebook.internal.Utility.closeQuietly(r11);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
    L_0x00c3:
        r8 = new com.facebook.FacebookException;	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r16 = r9.toString();	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        r0 = r16;
        r8.<init>(r0);	 Catch:{ IOException -> 0x0058, all -> 0x00d7 }
        goto L_0x00ae;
    L_0x00cf:
        r16 = "Unexpected error while downloading an image.";
        r0 = r16;
