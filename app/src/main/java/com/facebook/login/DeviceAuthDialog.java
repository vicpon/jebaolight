...
public class DeviceAuthDialog extends DialogFragment {
    ...
    class C04233 implements Runnable {
        C04233() {
        }
    ...
    class C04245 implements DialogInterface.OnClickListener {
        C04245() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C04261();
        ...
        static class C04261 implements Creator<RequestState> {
            C04261() {
            }
    ...
    class C05831 implements Callback {
        C05831() {
        }
    ...
    class C05844 implements Callback {
        C05844() {
        }
    ...
    public void startLogin(Request request) {
        ...
        new GraphRequest(null, DEVICE_LOGIN_ENDPOINT, parameters, HttpMethod.POST, new C05831()).executeAsync();
    }
...
//        ((Button) view.findViewById(C0395R.id.cancel_button)).setOnClickListener(new C04222());
//        this.instructions = (TextView) view.findViewById(C0395R.id.com_facebook_device_auth_instructions);
//        this.instructions.setText(Html.fromHtml(getString(C0395R.string.com_facebook_device_auth_instructions)));
        return view;
    }
    ...
    private void schedulePoll() {
        this.scheduledPoll = DeviceAuthMethodHandler.getBackgroundExecutor().schedule(new C04233(), this.currentRequestState.getInterval(), TimeUnit.SECONDS);
    }

    private GraphRequest getPollRequest() {
        Bundle parameters = new Bundle();
        parameters.putString("code", this.currentRequestState.getRequestCode());
        return new GraphRequest(null, DEVICE_LOGIN_STATUS_ENDPOINT, parameters, HttpMethod.POST, new C05844());
    }
    ...
    private void presentConfirmation(final String userId, final PermissionsPair permissions, final String accessToken, String name) {
        ...
        }).setPositiveButton(cancel, new C04245());
        builder.create().show();
    }
