...
public class LoginFragment extends Fragment {
    ...
    class C05881 implements OnCompletedListener {
        C05881() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.loginClient.setOnCompletedListener(new C05881());
...
//        View view = inflater.inflate(C0395R.layout.com_facebook_login_fragment, container, false);
//        final View progressBar = view.findViewById(C0395R.id.com_facebook_login_fragment_progress_bar);
...
//        return view;
    ...
    public void onPause() {
        ...
        if (getView() == null) {
            ...
            //progressBar = getView().findViewById(C0395R.id.com_facebook_login_fragment_progress_bar);
        }
//        if (progressBar != null) {
//            progressBar.setVisibility(8);
//        }
