...
public class ToolTipPopup {
    ...
    private final OnScrollChangedListener mScrollListener = new C04421();
    private Style mStyle = Style.BLUE;
    private final String mText;

    /* renamed from: com.facebook.login.widget.ToolTipPopup$1 */
    class C04421 implements OnScrollChangedListener {
        C04421() {
        }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C0435R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C0435R.id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C0435R.id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C0435R.id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C0435R.id.com_facebook_button_xout);
        }
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C0435R.id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0435R.drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C0435R.drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0435R.drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C0435R.drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0435R.drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C0435R.drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0435R.drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C0435R.drawable.com_facebook_tooltip_black_xout);
            }
            ...
            if (this.mNuxDisplayTime > 0) {
                this.mPopupContent.postDelayed(new C04432(), this.mNuxDisplayTime);
            }
            this.mPopupWindow.setTouchable(true);
            this.mPopupContent.setOnClickListener(new C04443());
        }
    }
