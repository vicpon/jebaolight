...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C03662();
    ...
    static class C03662 implements Creator {
        C03662() {
        }
    ...
    static class C05671 implements GraphMeRequestWithCacheCallback {
        C05671() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new C05671());
        }
    }
