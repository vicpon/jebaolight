...
public class InAppPurchaseEventManager {
    ...
    public static Object getServiceInterface(Context context, IBinder service) {
        Object obj = null;
        try {
            Method getInterfaceMethod = (Method) methodMap.get(GET_INTERFACE_METHOD);
            ...
            obj = getInterfaceMethod.invoke(null, args);
    ...
    public static String getPurchaseDetails(Context context, String sku, Object inAppBillingObj, boolean isSubscription) {
        ...
        try {
            Method getSkuDetailsMethod = (Method) methodMap.get(GET_SKU_DETAILS_METHOD);
            Class<?> iapClass = (Class) classMap.get(IN_APP_BILLING_SERVICE);
            ...
            if (skuDetails.getInt(RESPONSE_CODE) == 0) {
                ...
                return details.size() < 1 ? "" : (String) details.get(0);
            }
        } catch (ClassNotFoundException e) {
