    ...
    public static boolean logInAppPurchaseEvent(final Context context, int resultCode, Intent data) {
        ...
        ServiceConnection serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                AutomaticAnalyticsLogger.inAppBillingObj = InAppPurchaseEventManager.getServiceInterface(context, service);
                try {
                    ...
                    if (!skuDetails.equals("")) {
                        ...
                        params.putBoolean(Constants.IAP_SUBSCRIPTION_AUTORENEWING, purchaseDetails.optBoolean("autoRenewing", false));
                        ...
                        appEventsLogger.logPurchaseImplicitly(new BigDecimal(((double) jsonSkuDetails.getInt("price_amount_micros")) / 1000000.0d), Currency.getInstance(jsonSkuDetails.getString("price_currency_code")), params);
