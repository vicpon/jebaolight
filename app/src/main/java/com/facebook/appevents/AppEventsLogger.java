...
public class AppEventsLogger {
    ...
    static class C03835 implements Runnable {
        C03835() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C03841();
        ...
        static void onResume(Context context, AccessTokenAppIdPair accessTokenAppId, AppEventsLogger logger, long eventTime, String sourceApplicationInfo) throws Throwable {
            synchronized (staticLock) {
        ...
        static void onSuspend(Context context, AccessTokenAppIdPair accessTokenAppId, AppEventsLogger logger, long eventTime) throws Throwable {
            synchronized (staticLock) {
    ...
    private void logAppSessionResumeEvent(long eventTime, String sourceApplicationInfo) throws Throwable {
    ...
    private void logAppSessionSuspendEvent(long eventTime) throws Throwable {
    ...
    public static FlushBehavior getFlushBehavior() {
        FlushBehavior flushBehavior = null;
        synchronized (staticLock) {
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C03835(), 0, 86400, TimeUnit.SECONDS);
        }
    }
