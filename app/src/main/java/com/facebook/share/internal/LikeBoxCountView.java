...
//        this.caretHeight = getResources().getDimension(C0395R.dimen.com_facebook_likeboxcountview_caret_height);
//        this.caretWidth = getResources().getDimension(C0395R.dimen.com_facebook_likeboxcountview_caret_width);
//        this.borderRadius = getResources().getDimension(C0395R.dimen.com_facebook_likeboxcountview_border_radius);
//        this.borderPaint = new Paint();
//        this.borderPaint.setColor(getResources().getColor(C0395R.color.com_facebook_likeboxcountview_border_color));
//        this.borderPaint.setStrokeWidth(getResources().getDimension(C0395R.dimen.com_facebook_likeboxcountview_border_width));
...
//        this.likeCountLabel.setTextSize(0, getResources().getDimension(C0395R.dimen.com_facebook_likeboxcountview_text_size));
//        this.likeCountLabel.setTextColor(getResources().getColor(C0395R.color.com_facebook_likeboxcountview_text_color));
//        this.textPadding = getResources().getDimensionPixelSize(C0395R.dimen.com_facebook_likeboxcountview_text_padding);
//        this.additionalTextPadding = getResources().getDimensionPixelSize(C0395R.dimen.com_facebook_likeboxcountview_caret_height);
    }
