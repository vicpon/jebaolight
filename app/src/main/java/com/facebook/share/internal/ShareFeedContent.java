...
public class ShareFeedContent extends ShareContent<ShareFeedContent, ShareFeedContent.Builder> {
    public static final Creator<ShareFeedContent> CREATOR = new C04541();
    ...
    static class C04541 implements Creator<ShareFeedContent> {
        C04541() {
        }
    ...
    public static final class Builder extends com.facebook.share.model.ShareContent.Builder<ShareFeedContent, Builder> {
        ...
        public Builder readFrom(ShareFeedContent model) {
            ...
            return ((Builder) super.readFrom((ShareFeedContent) model)).setToId(model.getToId()).setLink(model.getLink()).setLinkName(model.getLinkName()).setLinkCaption(model.getLinkCaption()).setLinkDescription(model.getLinkDescription()).setPicture(model.getPicture()).setMediaSource(model.getMediaSource());
        }
    }
