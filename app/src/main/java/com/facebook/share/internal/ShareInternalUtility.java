...
public final class ShareInternalUtility {
    ...
    static class C06175 implements Mapper<Attachment, String> {
        C06175() {
        }
    ...
    static class C06208 implements PhotoJSONProcessor {
        C06208() {
        }
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, final UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                ...
                List<String> attachmentUrls = Utility.map(attachments, new C06175());
    ...
    public static JSONObject toJSONObjectForWeb(ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        return OpenGraphJSONUtility.toJSONObject(shareOpenGraphContent.getAction(), new C06208());
    }
