...
public class LikeActionController {
    ...
    static class C06013 implements Callback {
        C06013() {
        }
    ...
    static class C06025 extends AccessTokenTracker {
        C06025() {
        }
    ...
    class C06089 implements RequestCompletionCallback {
        C06089() {
        }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class C06091 implements GraphRequest.Callback {
            C06091() {
            }
        ...
        protected void setRequest(GraphRequest request) {
            ...
            request.setCallback(new C06091());
        }
...
*/
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C06013());
                isInitialized = true;
            }
        }
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C06089());
        }
    }
