...
public class ShareContentValidation {
    ...
    private static void validateCameraEffectContent(ShareCameraEffectContent cameraEffectContent, Validator validator) {
    ...
    private static void validateMessengerOpenGraphMusicTemplate(ShareMessengerOpenGraphMusicTemplateContent content) {
    ...
    private static void validateShareMessengerGenericTemplateContent(ShareMessengerGenericTemplateContent content) {
        if (Utility.isNullOrEmpty(content.getPageId())) {
    ...
    private static void validateShareMessengerMediaTemplateContent(ShareMessengerMediaTemplateContent content) {
        if (Utility.isNullOrEmpty(content.getPageId())) {
