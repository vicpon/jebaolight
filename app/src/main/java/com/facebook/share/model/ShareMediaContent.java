...
public final class ShareMediaContent extends ShareContent<ShareMediaContent, ShareMediaContent.Builder> {
    public static final Creator<ShareMediaContent> CREATOR = new C04621();
    private final List<ShareMedia> media;

    /* renamed from: com.facebook.share.model.ShareMediaContent$1 */
    static class C04621 implements Creator<ShareMediaContent> {
        C04621() {
        }
    ...
    public static class Builder extends com.facebook.share.model.ShareContent.Builder<ShareMediaContent, Builder> {
        ...
        public Builder readFrom(ShareMediaContent model) {
            ...
            return ((Builder) super.readFrom((ShareMediaContent) model)).addMedia(model.getMedia());
        }
