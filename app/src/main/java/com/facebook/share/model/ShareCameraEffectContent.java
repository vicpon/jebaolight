...
public class ShareCameraEffectContent extends ShareContent<ShareCameraEffectContent, ShareCameraEffectContent.Builder> {
    public static final Creator<ShareCameraEffectContent> CREATOR = new C04591();
    ...
    static class C04591 implements Creator<ShareCameraEffectContent> {
        C04591() {
        }
    ...
    public static final class Builder extends com.facebook.share.model.ShareContent.Builder<ShareCameraEffectContent, Builder> {
        ...
        public Builder readFrom(ShareCameraEffectContent model) {
            ...
            return ((Builder) super.readFrom((ShareCameraEffectContent) model)).setEffectId(this.effectId).setArguments(this.arguments);
        }
    }
