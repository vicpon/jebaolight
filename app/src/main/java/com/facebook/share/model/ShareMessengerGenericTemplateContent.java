...
public final class ShareMessengerGenericTemplateContent extends ShareContent<ShareMessengerGenericTemplateContent, ShareMessengerGenericTemplateContent.Builder> {
    public static final Creator<ShareMessengerGenericTemplateContent> CREATOR = new C04631();
    ...
    static class C04631 implements Creator<ShareMessengerGenericTemplateContent> {
        C04631() {
        }
    ...
    public static class Builder extends com.facebook.share.model.ShareContent.Builder<ShareMessengerGenericTemplateContent, Builder> {
        ...
        public Builder readFrom(ShareMessengerGenericTemplateContent model) {
            ...
            return ((Builder) super.readFrom((ShareMessengerGenericTemplateContent) model)).setIsSharable(model.getIsSharable()).setImageAspectRatio(model.getImageAspectRatio()).setGenericTemplateElement(model.getGenericTemplateElement());
        }
    }
