...
public final class ShareMessengerGenericTemplateElement implements ShareModel {
    public static final Creator<ShareMessengerGenericTemplateElement> CREATOR = new C04641();
    ...
    static class C04641 implements Creator<ShareMessengerGenericTemplateElement> {
        C04641() {
        }
