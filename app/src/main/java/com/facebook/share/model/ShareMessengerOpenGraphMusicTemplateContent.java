...
public final class ShareMessengerOpenGraphMusicTemplateContent extends ShareContent<ShareMessengerOpenGraphMusicTemplateContent, ShareMessengerOpenGraphMusicTemplateContent.Builder> {
    public static final Creator<ShareMessengerOpenGraphMusicTemplateContent> CREATOR = new C04661();
    private final ShareMessengerActionButton button;
    private final Uri url;

    /* renamed from: com.facebook.share.model.ShareMessengerOpenGraphMusicTemplateContent$1 */
    static class C04661 implements Creator<ShareMessengerOpenGraphMusicTemplateContent> {
        C04661() {
        }
    ...
    public static class Builder extends com.facebook.share.model.ShareContent.Builder<ShareMessengerOpenGraphMusicTemplateContent, Builder> {
        ...
        public Builder readFrom(ShareMessengerOpenGraphMusicTemplateContent content) {
            ...
            return ((Builder) super.readFrom((ShareMessengerOpenGraphMusicTemplateContent) content)).setUrl(content.getUrl()).setButton(content.getButton());
        }
