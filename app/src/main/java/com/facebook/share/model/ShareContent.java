...
public abstract class ShareContent<P extends ShareContent, E extends ShareContent.Builder> implements ShareModel {
    ...
    public static abstract class Builder<P extends ShareContent, E extends Builder> implements ShareModelBuilder<P, E> {
        ...
        public E setPageId(@Nullable String pageId) {
            this.pageId = pageId;
            return (E) this;
        }
        ...
        public E readFrom(P content) {
            ...
            return (E) setContentUrl(content.getContentUrl()).setPeopleIds(content.getPeopleIds()).setPlaceId(content.getPlaceId()).setPageId(content.getPageId()).setRef(content.getRef());
        }
    }
