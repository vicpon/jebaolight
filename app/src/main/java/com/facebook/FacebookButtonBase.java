...
//        if (defStyleRes == 0) {
//            defStyleRes = C0395R.style.com_facebook_button;
//        }
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (a.hasValue(0)) {
                    ...
                    //setBackgroundColor(ContextCompat.getColor(context, C0395R.color.com_facebook_blue));
                }
                a.recycle();
            } catch (Throwable th) {
                a.recycle();
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C03581());
    }
}
