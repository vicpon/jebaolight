...
public final class FacebookSdk {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new C03601();
    ...
    static class C03612 implements Callable<File> {
        C03612() {
        }
    ...
    public static synchronized void sdkInitialize(Context applicationContext, final InitializeCallback callback) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                cacheDir = new LockOnGetVariable(new C03612());
                final Context finalApplicationContext = applicationContext;
                getExecutor().execute(new FutureTask(new Callable<Void>() {
                    public Void call() throws Exception {
                        ...
                        AppEventsLogger.newLogger(finalApplicationContext.getApplicationContext()).flush();
                        return null;
                    }
                }));
...
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.facebook.FacebookSdk.publishInstallAndWaitForResponse(android.content.Context, java.lang.String):void. bs: [B:2:0x0004, B:10:0x0037]
	...
	at jadx.api.JadxDecompiler$$Lambda$8/154482552.run(Unknown Source)
*/
        /*
    ...
    static void loadDefaultsFromMetadata(Context context) {
        if (context != null) {
            try {
                @SuppressLint("WrongConstant") ApplicationInfo ai = context.getPackageManager().getApplicationInfo(context.getPackageName(), 128);
                if (ai != null && ai.metaData != null) {
                    if (applicationId == null) {
                        String appId = (String) ai.metaData.get(APPLICATION_ID_PROPERTY);
    ...
    public static String getApplicationSignature(Context context) {
        ...
        try {
            @SuppressLint("WrongConstant") PackageInfo pInfo = packageManager.getPackageInfo(context.getPackageName(), 64);
    ...
    public static void setCacheDir(LockOnGetVariable<File> cacheDir) {
        cacheDir = new LockOnGetVariable<File>((Callable<File>) cacheDir);
    }
