...
final class UPCEANExtension5Support {
    ...
    private static String parseExtension5String(String raw) {
        ...
        return currency + String.valueOf(rawAmount / 100) + '.' + (hundredths < 10 ? new StringBuilder(AppEventsConstants.EVENT_PARAM_VALUE_NO).append(hundredths).toString() : String.valueOf(hundredths));
    }
}
